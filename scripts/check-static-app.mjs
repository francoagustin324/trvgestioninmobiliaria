...
for (const text of ['TRV CRM', 'CRM / Leads', 'Propiedades', 'Agenda / Seguimiento', 'localStorage', 'Alertas comerciales', 'Semáforo comercial', 'Cliente caliente sin contactar', 'Ver más', 'Fichas TRV', 'WhatsApp + IA', 'Nuevo cliente', 'trv-logo.svg', 'Guardar ficha en TRV', 'Propiedad sujeta a disponibilidad', 'Link original interno', 'window.print', 'wa.me']) {
