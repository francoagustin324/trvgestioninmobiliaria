-- SEC-FIX A2.4 — alineación reproducible de RPC V2 org-aware.
...
create or replace function public.visit_transaction_authority_active_v2(
...
revoke all privileges on function public.visit_transaction_authority_active_v2(uuid)
