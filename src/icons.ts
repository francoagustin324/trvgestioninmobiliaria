...
export const appIcons = {
  ...
  // Configuración/Ajustes: engranaje.
  config: '<svg viewBox="0 0 24 24" role="img"><circle cx="12" cy="12" r="3.2"/><path d="M19.4 13.5a1.7 1.7 0 0 0 .34 1.87l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.7 1.7 0 0 0-1.87-.34 1.7 1.7 0 0 0-1.03 1.56V21a2 2 0 0 1-4 0v-.1a1.7 1.7 0 0 0-1.11-1.56 1.7 1.7 0 0 0-1.87.34l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.7 1.7 0 0 0 .34-1.87 1.7 1.7 0 0 0-1.56-1.03H3a2 2 0 0 1 0-4h.1a1.7 1.7 0 0 0 1.56-1.11 1.7 1.7 0 0 0-.34-1.87l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.7 1.7 0 0 0 1.87.34H9a1.7 1.7 0 0 0 1.03-1.56V3a2 2 0 0 1 4 0v.1a1.7 1.7 0 0 0 1.03 1.56 1.7 1.7 0 0 0 1.87-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.7 1.7 0 0 0-.34 1.87V9a1.7 1.7 0 0 0 1.56 1.03H21a2 2 0 0 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1.03Z"/></svg>',
  sync: '<svg viewBox="0 0 24 24" role="img"><path d="M20 7v5h-5"/><path d="M4 17v-5h5"/><path d="M6.1 8.3A7 7 0 0 1 18.8 7L20 12"/><path d="M17.9 15.7A7 7 0 0 1 5.2 17L4 12"/></svg>',
  history: '<svg viewBox="0 0 24 24" role="img"><path d="M4 4v5h5"/><path d="M5.3 16.5A8 8 0 1 0 4.7 8"/><path d="M12 7.5V12l3 2"/></svg>',
  logout: '<svg viewBox="0 0 24 24" role="img"><path d="M10 4H5.5A2.5 2.5 0 0 0 3 6.5v11A2.5 2.5 0 0 0 5.5 20H10"/><path d="M14 8l4 4-4 4M18 12H8"/></svg>',
  cloudCheck: '<svg viewBox="0 0 24 24" role="img"><path d="M7 18.5h10.5a4 4 0 0 0 .45-7.97A6.5 6.5 0 0 0 5.6 9.1 4.75 4.75 0 0 0 7 18.5Z"/><path d="m9.5 13.7 1.8 1.8 3.5-3.7"/></svg>',
} as const;
