...
function invitationShell(content: string): string {
  return `<main class="public-auth-shell">
    <section class="public-auth-brand">
      ...
      <div><span>CRM inmobiliario</span><h1>Activá tu acceso a ${PRODUCT_BRAND.name}.</h1><p>Tu cuenta quedará vinculada únicamente a la inmobiliaria que te invitó.</p></div>
    </section>
